...
| ITEM |   Description.  |
| :--- | :-------------- |
| Contract Address <- Our hack target |  [Paradigm-CTF-2021-Broker](https://github.com/paradigmxyz/paradigm-ctf-2021/tree/master/broker/public)     |
...
| Solution Contract  |  [Solution](https://github.com/paradigmxyz/paradigm-ctf-2021/blob/master/broker/private/Exploit.sol)                         |
